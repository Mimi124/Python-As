def main():
    ...
    accountHoldersName = ["Derrick Danso", "enock foli", "jaden amoako", "jenifer gyasi", "darlington gyasi"]
    accountNumber = ['*****1353', '199281', "182838", "185597", "667432"]
    balance = ['2,000,000,000', 21873, 2341871, 275638, 91820]

    flag = False
    for i in range (0,999999999): #so the loop runs almost infinit many times
        print("""
    \t\t=== Welcome To Paris CDG Term k1 * ATM B4 ===
""")
        ...
        if flag == True:
            ...
            print("Your account balance is: Euros", balance[index])
            ...
            print("\n\nThank you for using Paris CDG Term k1* ATM B4. \n  ")
